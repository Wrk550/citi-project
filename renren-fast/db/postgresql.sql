...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (5, 1, 'SQL监控', 'http://localhost:9000/renren-fast/druid/sql.html', NULL, 1, 'sql', 4);
